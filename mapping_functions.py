...
if __name__ == '__main__':
    ...
    text = load('/media/windows-share/SEC_Downloads/A/1090872/10-K/0001090872-16-000082.txt')
    ...
    single_count_tuples = pool.map(map_function, partitioned_text)

    # Organize the count tuples; lists of tuples by token key
    token_to_tuples = partition(single_count_tuples)

    # Collapse the lists of tuples into total term frequencies
    term_frequencies = pool.map(reduce_function, token_to_tuples.items())
